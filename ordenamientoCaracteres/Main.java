package ordenamientoCaracteres;
...
public class Main {
    ...
    public static char[] generarArreglo(int n) {
        char[] randomArray = new char[n];
        Random random = new Random();
        for (int i = 0; i < n; i++) {
            randomArray[i] = (char) (random.nextInt(26)+'a');
        }
        return randomArray;
    }
    ...
    public static char[] quicksort(char[] item, int left, int right) {
        int i, j;
        char temp;
        i = left;
        j = right;
